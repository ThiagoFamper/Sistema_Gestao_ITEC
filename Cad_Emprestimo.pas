...
procedure TCadEmprestimo.SBcancelarClick(Sender: TObject); // botão de cancelar
begin
...
procedure TCadEmprestimo.SBnovoClick(Sender: TObject); // botão de novo
begin
  HabilitaCampos();
...
procedure TCadEmprestimo.SBpesquisarClick(Sender: TObject);
begin
  TelaPrincipal.AbrirFormulario(TListaEmprestimo); // botão de pesquisar
end;

procedure TCadEmprestimo.SBsairClick(Sender: TObject);
begin
  Close; // botão de sair
end;

procedure TCadEmprestimo.SBsalvarClick(Sender: TObject); // botão de salvar
var
...
procedure TCadEmprestimo.HabilitaCampos; // habilitar campos
begin
    dbEmpCod.Enabled            := True;
    dbEmpQtd.Enabled            := True;
end;

procedure TCadEmprestimo.DesabilitaCampos; // desabilitar campos
begin
